      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center">
            <div className="text-[11px] uppercase tracking-wide text-mp-gray-400 mb-1">Your production leads</div>
            ...
            <div className="text-[12px] text-mp-gray-500 mt-1">First call is with our Client Development team. We assign your producer after that.</div>
          </div>
        </motion.div>
      </div>
    </section>
